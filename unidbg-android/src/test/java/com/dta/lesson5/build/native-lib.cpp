...
Java_com_dta_lesson5_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_dta_lesson5_MainActivity_md5(JNIEnv *env, jobject thiz, jstring data) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_dta_lesson5_MainActivity_md52(JNIEnv *env, jobject thiz, jbyteArray data) {
    ...
    jclass MainActivity = env->FindClass("com/dta/lesson5/MainActivity");
    jmethodID byte2hex = env->GetMethodID(MainActivity, "byte2hex", "([B)Ljava/lang/String;");
    jstring string_result = (jstring) env->CallObjectMethod(thiz, byte2hex, result);
